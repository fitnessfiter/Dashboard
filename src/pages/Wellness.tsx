          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="glass rounded-xl p-6 neon-glow">
              <h1 className="text-3xl font-bold text-cyber-white mb-2">
                <span className="text-transparent bg-clip-text bg-neon-gradient">Wellness Intelligence</span>
              </h1>
              <p className="text-cyber-white/70">
                Comprehensive wellness tracking including sleep, stress, and recovery metrics.
              </p>
            </div>
